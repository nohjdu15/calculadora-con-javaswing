...
public class calculadorajhon extends javax.swing.JFrame {
    public float primernum;
    public float segundonum;
    public String operador;
    
    public calculadorajhon() {
        initComponents();
    ...
    private void initComponents() {
        ...
        casilla.setBackground(new java.awt.Color(153, 153, 153));
        casilla.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(153, 0, 0)));
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        this.segundonum=Float.parseFloat(this.casilla.getText());
        
        switch(this.operador){
            case "+":this.casilla.setText(sincero(this.primernum+this.segundonum));break;
            case "-":this.casilla.setText(sincero(this.primernum-this.segundonum));break;
            case "*":this.casilla.setText(sincero(this.primernum*this.segundonum));break;
            case "/": 
                if(this.segundonum==0){
                    ...
                    this.casilla.setText(sincero(this.primernum/this.segundonum));}break;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calculadorajhon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calculadorajhon().setVisible(true);
            }
        });
    }
